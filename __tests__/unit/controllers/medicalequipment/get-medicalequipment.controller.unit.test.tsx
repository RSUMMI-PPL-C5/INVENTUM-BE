...
describe("MedicalEquipmentController - GET Methods", () => {
  ...
  describe("getMedicalEquipment", () => {
    ...
    it("should use custom pagination parameters", async () => {
      ...
      const mockEquipments = Array(20)
        .fill(null)
        .map((_, i) => createMockEquipment(`${i + 21}`, `Equipment ${i + 21}`));
    ...
    it("should handle general errors with 500 status", async () => {
      // Arrange
      mockService.getMedicalEquipment.mockRejectedValue(
    ...
    it("should handle negative pagination values", async () => {
      ...
      const mockEquipments = [createMockEquipment("1", "Equipment 1")];
  ...
  describe("getMedicalEquipmentById", () => {
    it("should return equipment when found", async () => {
      ...
      // Assert
      expect(mockService.getMedicalEquipmentById).toHaveBeenCalledWith(
        "test-id",
      );
      expect(mockResponse.status).toHaveBeenCalledWith(200);
      expect(mockResponse.json).toHaveBeenCalledWith({
    ...
    it("should handle general errors with 500 status", async () => {
      ...
      mockService.getMedicalEquipmentById.mockRejectedValue(
        new Error("Database error"),
      );
