...
describe("ReportController", () => {
  ...
  describe("exportPlanReportsToCSV", () => {
    it("should export plan reports to CSV", async () => {
      // Arrange
      mockReq.query = {
        search: "test",
        status: "scheduled",
      ...
      const mockCSV =
        "id,equipment,type,status,date,requestor\n1,X-Ray,MAINTENANCE,SCHEDULED,2023-01-15,John";
      mockReportService.exportPlanReportsToCSV = jest
        .fn()
        .mockResolvedValue(mockCSV);

      // Act
      await controller.exportPlanReportsToCSV(
        mockReq as Request,
        mockRes as Response,
        mockNext,
      );
      ...
      // Assert
      expect(mockReportService.exportPlanReportsToCSV).toHaveBeenCalledWith({
        search: "test",
        status: "scheduled",
        type: "MAINTENANCE",
        startDate: "2023-01-01",
    ...
    it("should handle invalid status and type parameters", async () => {
      // Arrange
      mockReq.query = {
      ...
      const mockCSV = "id,equipment,type,status,date,requestor\n";
      mockReportService.exportPlanReportsToCSV = jest
        .fn()
        .mockResolvedValue(mockCSV);
    ...
    it("should handle errors", async () => {
      // Arrange
      const mockError = new Error("Failed to export plan reports");
      mockReportService.exportPlanReportsToCSV = jest
        .fn()
        .mockRejectedValue(mockError);
  ...
  describe("exportResultReportsToCSV", () => {
    it("should export result reports to CSV", async () => {
      // Arrange
      mockReq.query = {
        search: "test",
        result: "success",
      ...
      const mockCSV = "type,id,equipment,date,technician,result,action\n";
      mockReportService.exportResultReportsToCSV = jest
        .fn()
        .mockResolvedValue(mockCSV);

      // Act
      await controller.exportResultReportsToCSV(
        mockReq as Request,
        mockRes as Response,
        mockNext,
      );
      ...
      // Assert
      expect(mockReportService.exportResultReportsToCSV).toHaveBeenCalledWith({
        search: "test",
        result: "success",
        type: "MAINTENANCE",
        startDate: "2023-01-01",
    ...
    it("should handle invalid result and type parameters", async () => {
      // Arrange
      mockReq.query = {
    ...
    it("should handle errors", async () => {
      // Arrange
      const mockError = new Error("Failed to export result reports");
      mockReportService.exportResultReportsToCSV = jest
        .fn()
        .mockRejectedValue(mockError);
  ...
  describe("exportSummaryReportsToCSV", () => {
    it("should export summary reports to CSV", async () => {
      // Arrange
      mockReq.query = {
        search: "test",
        type: "MAINTENANCE",
      ...
      const mockCSV = "type,id,equipment,date,comment,username\n";
      mockReportService.exportSummaryReportsToCSV = jest
        .fn()
        .mockResolvedValue(mockCSV);

      // Act
      await controller.exportSummaryReportsToCSV(
        mockReq as Request,
        mockRes as Response,
        mockNext,
      );
      ...
      // Assert
      expect(mockReportService.exportSummaryReportsToCSV).toHaveBeenCalledWith({
        search: "test",
        type: "MAINTENANCE",
        startDate: "2023-01-01",
        endDate: "2023-12-31",
    ...
    it("should handle errors", async () => {
      // Arrange
      const mockError = new Error("Failed to export summary reports");
      mockReportService.exportSummaryReportsToCSV = jest
        .fn()
        .mockRejectedValue(mockError);
