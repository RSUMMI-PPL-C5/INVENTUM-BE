...
describe("DivisionController", () => {
  ...
  describe("getDivisionsTree", () => {
    it("should return divisions hierarchy with 200 status code", async () => {
      // Arrange
      const mockHierarchy = [{ id: 1, divisi: "Engineering", parentId: null, children: [] }];
      mockDivisionService.getDivisionsHierarchy = jest.fn().mockResolvedValue(mockHierarchy);
    ...
    it("should handle errors and return 500 status code", async () => {
      ...
      mockDivisionService.getDivisionsHierarchy = jest.fn().mockRejectedValue(new Error(errorMessage));
  ...
  describe("getAllDivisions", () => {
    it("should return all divisions with 200 status code", async () => {
      ...
      mockDivisionService.getAllDivisions = jest.fn().mockResolvedValue(mockDivisions);
    ...
    it("should handle errors and return 500 status code", async () => {
      // Arrange
      const errorMessage = "Service error";
      mockDivisionService.getAllDivisions = jest.fn().mockRejectedValue(new Error(errorMessage));
  ...
  describe("getDivisionsWithUserCount", () => {
    it("should return divisions with user count and 200 status code", async () => {
      ...
      mockDivisionService.getDivisionsWithUserCount = jest.fn().mockResolvedValue(mockDivisionsWithCount);
    ...
    it("should handle errors and return 500 status code", async () => {
      // Arrange
      const errorMessage = "Service error";
      mockDivisionService.getDivisionsWithUserCount = jest.fn().mockRejectedValue(new Error(errorMessage));
