...
describe('MedicalEquipmentService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    mockRepository = new MedicalEquipmentRepository() as jest.Mocked<MedicalEquipmentRepository>;
  ...
  describe('getMedicalEquipment', () => {
    ...
    it('should return all medical equipment', async () => {
      ...
      mockRepository.getMedicalEquipment = jest.fn().mockResolvedValue(mockData);
  ...
  describe('getMedicalEquipmentById', () => {
    ...
    it('should return equipment when found by ID', async () => {
      ...
      mockRepository.getMedicalEquipmentById = jest.fn().mockResolvedValue(mockData);
    ...
    it('should return null when equipment not found by ID', async () => {
      ...
      mockRepository.getMedicalEquipmentById = jest.fn().mockResolvedValue(null);
    ...
    it('should throw error when repository throws an error', async () => {
      ...
      const id = 'error-id';
      const error = new Error('Database error');
      mockRepository.getMedicalEquipmentById = jest.fn().mockRejectedValue(error);
  ...
  describe('getFilteredMedicalEquipment', () => {
    ...
    it('should return filtered equipment', async () => {
      ...
      mockRepository.getFilteredMedicalEquipment = jest.fn().mockResolvedValue(mockData);

      // Act
      const result = await service.getFilteredMedicalEquipment(filters);

      // Assert
      expect(filterHandlers[0]).toHaveBeenCalledWith(filters, expect.any(Object));
    ...
    it('should throw error when repository throws an error', async () => {
      ...
      mockRepository.getFilteredMedicalEquipment = jest.fn().mockRejectedValue(error);

      // Act & Assert
      await expect(service.getFilteredMedicalEquipment(filters)).rejects.toThrow(error);
      expect(mockRepository.getFilteredMedicalEquipment).toHaveBeenCalled();
    });
  ...
  describe('searchMedicalEquipment', () => {
    ...
    it('should return equipment matching the name search', async () => {
      ...
      mockRepository.getMedicalEquipmentByName = jest.fn().mockResolvedValue(mockData);

      // Act
      const result = await service.searchMedicalEquipment(name);

      // Assert
      expect(mockRepository.getMedicalEquipmentByName).toHaveBeenCalledWith(name);
      expect(result).toEqual(mockData);
    });
    ...
    it('should trim the search string', async () => {
      ...
      // Assert
      expect(mockRepository.getMedicalEquipmentByName).toHaveBeenCalledWith(trimmedName);
      expect(result).toEqual(mockData);
    });
    ...
    it('should throw error when name is empty string', async () => {
      ...
      // Act & Assert
      await expect(service.searchMedicalEquipment(name)).rejects.toThrow('Name query is required');
    ...
    it('should throw error when repository throws an error', async () => {
      ...
      mockRepository.getMedicalEquipmentByName = jest.fn().mockRejectedValue(error);
    ...
    it('should return empty array when no equipment matches search', async () => {
      ...
      mockRepository.getMedicalEquipmentByName = jest.fn().mockResolvedValue([]);
