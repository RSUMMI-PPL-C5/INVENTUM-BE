...
describe('MedicalEquipmentService - deleteMedicalEquipment', () => {
  ...
  it('should successfully delete a medical equipment', async () => {
    ...
    // Act
    const result = await service.deleteMedicalEquipment(equipmentId, deletedById);

    // Assert
    expect(mockRepository.findById).toHaveBeenCalledWith(equipmentId);
    expect(mockRepository.deleteMedicalEquipment).toHaveBeenCalledWith(equipmentId, deletedById);
  ...
  it('should work without deletedById parameter', async () => {
    ...
    // Assert
    expect(mockRepository.deleteMedicalEquipment).toHaveBeenCalledWith(equipmentId, undefined);
    expect(result).toEqual(deletedEquipment);
  });
});