...
describe('Invalid Values Handling', () => {
  ...
  it('should reject array with one invalid status', async () => {
    ...
    const result = await runValidation(medicalEquipmentFilterQueryValidation, mockRequest);
...
describe('Medical Equipment Filter Query Validation', () => {
  ...
  describe('Combined Filters', () => {
    it('should handle multiple valid filters', async () => {
      ...
      expect(dateUtils.toJakartaDate).toHaveBeenCalledWith('2023-01-01T00:00:00Z');
      expect(dateUtils.toJakartaDate).toHaveBeenCalledWith('2023-12-31T00:00:00Z', true);
      expect(dateUtils.toJakartaDate).toHaveBeenCalledWith('2023-02-01T00:00:00Z');
      expect(dateUtils.toJakartaDate).toHaveBeenCalledWith('2023-11-30T00:00:00Z', true);
      expect(dateUtils.toJakartaDate).toHaveBeenCalledWith('2023-03-01T00:00:00Z');
      expect(dateUtils.toJakartaDate).toHaveBeenCalledWith('2023-10-31T00:00:00Z', true);
    });
