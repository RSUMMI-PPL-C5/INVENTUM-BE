...
describe("SparepartRepository - READ", () => {
  ...
  describe("getSpareparts", () => {
    ...
    it("should return all spareparts with no filters, search or pagination", async () => {
      // Setup mock
      (mockPrisma.spareparts.findMany as jest.Mock).mockResolvedValue(mockSpareparts);
    ...
    it("should apply partsName filter correctly", async () => {
      ...
      // Setup mock
      (mockPrisma.spareparts.findMany as jest.Mock).mockResolvedValue([mockSpareparts[0]]);
      (mockPrisma.spareparts.count as jest.Mock).mockResolvedValue(1);

      // Call the method
      const result = await sparepartRepository.getSpareparts(undefined, filters);
    ...
    it("should apply toolLocation filter correctly", async () => {
      ...
      // Setup mock
      (mockPrisma.spareparts.findMany as jest.Mock).mockResolvedValue([mockSpareparts[1]]);
      (mockPrisma.spareparts.count as jest.Mock).mockResolvedValue(1);
    ...
    it("should apply pagination correctly", async () => {
      ...
      // Call the method
      const result = await sparepartRepository.getSpareparts(undefined, undefined, pagination);
    ...
    it("should apply combined search, filters, and pagination correctly", async () => {
      ...
      // Call the method
      const result = await sparepartRepository.getSpareparts(searchTerm, filters, pagination);
  ...
  describe("getSparepartById", () => {
    it("should return a sparepart when found by ID", async () => {
      ...
      // Setup mock
      (mockPrisma.spareparts.findFirst as jest.Mock).mockResolvedValue(mockSparepart);
