...
import { addSparepartValidation, updateSparepartValidation } from '../validations/spareparts.validation';
...
router.get('/', sparepartFilterQueryValidation, sparepartController.getSpareparts);
router.get('/:id', sparepartController.getSparepartById);
router.post('/', addSparepartValidation, validateRequest, sparepartController.addSparepart);
router.put('/:id', updateSparepartValidation, validateRequest, sparepartController.updateSparepart);
